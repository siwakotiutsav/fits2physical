...
![Example NGC 253 JWST Analysis](docs/_static/example_plot.png)

*Example FITS analysis of NGC 253.*  
Data are from **JWST Cycle 1 GO Programme 1701 (PI: Alberto D. Bolatto et al.)**, which includes high‑resolution imaging of the starburst galaxy NGC 253. JWST NIRCam and MIRI observations trace dust, PAH emission, and outflow structures in this archetypal starburst. :contentReference[oaicite:5]{index=5}
